...
public class Dungeon {
	...
	final public int tileUnused = 0;
	final public int tileDirtWall = 1; //not in use
	final public int tileDirtFloor = 2;
	final public int tileStoneWall = 3;
	final public int tileCorridor = 4;
	final public int tileDoor = 5;
	final public int tileUpStairs = 6;
	final public int tileDownStairs = 7;
	final public int tileChest = 8;
